...
INSERT INTO fitness_services (service_id, promo_id, status, title, duration, description, other_information, price) VALUES
('99a836ab-8f83-4e63-b266-3f56b1396df4', 'a062ff08-d00f-47d9-88d3-e35e7d0446a3','VISIBLE', 'Personal Training', '1 hour', 'One-on-one personalized training session','Tailored fitness guidance by Sarah.', 100.00),
('99a836ab-8f83-4e63-b266-3f56b1396df5', '9ecab68a-fe7d-40c2-bd4f-62d2854ad92d', 'VISIBLE', 'Yoga Classes', '45 minutes', 'Group yoga sessions for all levels','Yoga for well-being and balance for all.', 50.00),
('6b91f458-9eea-4336-8832-62e0a8d38ccb', '2644a7cb-59ce-4f8d-9db2-36e0a06b6508', 'VISIBLE', 'High-Intensity Interval Training', '30 minutes', 'High-intensity interval training in a group setting','High-energy workout.', 75.00),
('b5c6caef-86b3-4a55-8984-0be52a1349c8', '29ebf549-2caf-4919-ba15-9c5904534dc1', 'INVISIBLE','Nutrition Planning', '1 hour', 'Personalized nutrition planning and guidance','Personalized health and diet plans.', 60.00),
('f4f956ed-c6bf-421b-bcf0-36f7c29a848c', '1de4e220-af32-4f0d-94eb-1b906bb8b2e1', 'INVISIBLE','Cycling Class', '1 hour', 'Indoor cycling for fitness and endurance','Intense cycling for strength and endurance.', 40.00);
