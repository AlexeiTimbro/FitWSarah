...
INSERT INTO appointments (appointment_id, admin_id, account_id, service_id, status, location,available_status,available_date) VALUES
('uuid-appt1',  'uuid-admin1','uuid-acc1', 'uuid-service1', 'Scheduled', 'Location 1','available', '2023-09-19'),
('uuid-appt2',  'uuid-admin2','uuid-acc2', 'uuid-service2', 'Completed', 'Location 2', 'available',  '2023-09-19'),
('uuid-appt3',  'uuid-admin3','uuid-acc3', 'uuid-service3', 'Cancelled', 'Location 3', 'not available','2023-09-19'),
('uuid-appt4',  'uuid-admin4','uuid-acc4', 'uuid-service4', 'Scheduled', 'Location 4', 'not available', '2023-09-19'),
('uuid-appt5',  'uuid-admin5','uuid-acc5', 'uuid-service5', 'Completed', 'Location 5', 'available', '2023-09-19');
...
INSERT INTO promo_offers (promotion_id, title,  description, price) VALUES
('a062ff08-d00f-47d9-88d3-e35e7d0446a3', 'New Year Fitness Special',  'Discount on personal training sessions for new members', 80.00),
('9ecab68a-fe7d-40c2-bd4f-62d2854ad92d', 'Summer Yoga Deal',  'Unlimited yoga classes for the summer season', 120.00),
('2644a7cb-59ce-4f8d-9db2-36e0a06b6508', 'Boot Camp Blast',  'Intensive boot camp course for advanced practitioners', 150.00),
('29ebf549-2caf-4919-ba15-9c5904534dc1', 'Nutrition Newcomer',  'First-time consultation discount for nutrition planning', 45.00),
('1de4e220-af32-4f0d-94eb-1b906bb8b2e1', 'Cycling Challenge', 'Join our monthly cycling challenge and win prizes', 30.00);
